...
public class WrongAnswer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_question = (Button) findViewById(R.id.wrong_new_question);
        main_screen = (Button) findViewById(R.id.wrong_ana_ekran);

        hak = (TextView) findViewById(R.id.wrong_rem);
        puan = (TextView) findViewById(R.id.wrong_points);
        ...
        main_screen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(WrongAnswer.this, DashboardActivity.class));
        ...
        new_question.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!"0".equals(get_hak)) {
                    finish();
                    startActivity(new Intent(WrongAnswer.this, QuestionActivity.class));
                    overridePendingTransition(0, 0);
                } else {
                    finish();
                    startActivity(new Intent(WrongAnswer.this, DashboardActivity.class));
